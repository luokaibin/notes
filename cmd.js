...
const ignoreDir = ['work', 'myStory', '杂记.md', 'QQMusicApi.md', 'engineering', 'discipline', 'static', '树莓派入门到实战.md', 'Docker 安装 Jenkins.md', '视频工厂.md', 'WebComponent.md', 'centos 安装 puppeteer.md'];
